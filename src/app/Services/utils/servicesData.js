...
export const serviceDetailsMap = {
  ...
  'saas-product-architecture-development': {
    ...
    badge: 'SOFTWARE & ENTERPRISE',
    heroDescription: 'We build scalable SaaS platforms with cloud-ready architecture, multi-tenancy support, subscription management, and performance optimization.',
    aboutSection: {
      title: 'SaaS Product Architecture & Development',
      description: 'Launch your SaaS product with confidence using our proven architecture and development approach. We design scalable, multi-tenant platforms that can grow from startup to enterprise scale. Our solutions include subscription management, usage-based billing, tenant isolation, and cloud-native architecture optimized for performance and cost efficiency.',
      image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&h=600&fit=crop'
    },
    keyFeatures: {
      description: 'Scalable SaaS platforms built for growth and performance.',
      features: [
  ...
  'legacy-system-modernization-migration': {
    ...
    badge: 'SOFTWARE & ENTERPRISE',
    heroDescription: 'We modernize outdated legacy systems by migrating them to modern stacks while preserving core business logic and ensuring data integrity.',
    aboutSection: {
      title: 'Legacy System Modernization & Migration',
      description: 'Transform your legacy systems into modern, maintainable platforms without disrupting your business operations. We carefully analyze your existing systems, preserve critical business logic, and migrate to modern technology stacks. Our approach ensures data integrity, minimizes downtime, and provides a clear path forward for future enhancements.',
      image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&h=600&fit=crop'
    },
    keyFeatures: {
      description: 'Safe and efficient legacy system modernization.',
      features: [
...
export function getServiceDetails(subslug) {
  ...
  return serviceDetailsMap[normalizedSubslug] || null;
}
