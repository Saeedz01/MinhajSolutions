      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {technologies.map((tech, index) => (
            <div
              key={index}
              className="bg-white h-36 w-56 border-2 border-blue-100 rounded-xl p-8 flex items-center justify-center hover:shadow-lg hover:border-black transition-all duration-300 hover:scale-105 cursor-pointer aspect-square"
            >
              <img
                src={tech.logo}
                alt={tech.name}
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML = `<div class="text-center text-gray-700 font-semibold text-sm">${tech.name}</div>`;
                }}
              />
            </div>
          ))}
