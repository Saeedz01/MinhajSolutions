        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="relative">
              ...
              {servicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-72 bg-white border border-gray-200 rounded-lg shadow-lg py-2">
            ...
            <a href="/Portfolio" className={navLinkClass("/Pricing")}>Portfolio</a>
            <a href="/Blog" className="text-gray-800 hover:text-cyan-900">Blog</a>
            <a href="/About" className={navLinkClass("/Dashboard")}>About</a>
            <a href="/Contact" className={navLinkClass("/Dashboard")}>Contact</a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a
              ...
              className="flex items-center gap-2 border border-gray-300 rounded-full px-3 py-1 text-gray-800"
            >
              <Phone size={16} />
                ...
                <div className="mt-2 ml-3 flex flex-col gap-2">
                  {serviceItems.map((item, index) => (
                    <a
                      ...
                      className="text-gray-700 hover:text-cyan-900"
                    >
                      {item}
                    </a>
                  ))}
