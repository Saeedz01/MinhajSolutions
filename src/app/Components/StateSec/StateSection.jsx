...
export default function TrustedStatsSection() {
  ...
  return (
    <section className="bg-cyan-900 min-h-96 flex items-center px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-center mb-4">
                  <div className="w-14 h-14 bg-cyan-700/50 rounded-full flex items-center justify-center">
