    ...
    <div className="bg-gray-50 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <button className="px-10 py-4 bg-transparent border-2 border-cyan-800 text-cyan-800 font-semibold rounded-lg hover:bg-cyan-800 hover:text-white transition-all duration-300 inline-flex items-center gap-2 text-lg">
            Let's Talk
