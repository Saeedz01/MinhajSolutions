        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {industries.map((industry) => {
            ...
            return (
              <div
                key={industry.id}
                className="group bg-white rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-cyan-800 hover:scale-105 cursor-pointer"
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                  {/* Icon */}
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 sm:w-16 sm:h-16 bg-cyan-50 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-2 transition-all duration-500">
                  ...
                  <div className="flex-1 mt-4 sm:mt-0">
                    ...
                    {/* Underline Bar */}
                    <div className="relative mb-3 w-full max-w-[440px]">
                      <div className="w-full h-[1px] bg-gray-300"></div>
                      <div className="absolute top-0 left-0 w-0 h-[1px] bg-cyan-800 transition-all duration-300 ease-in-out group-hover:w-full"></div>
                    </div>
